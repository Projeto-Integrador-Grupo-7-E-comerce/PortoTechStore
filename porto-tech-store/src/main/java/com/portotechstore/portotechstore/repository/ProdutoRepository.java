...
public interface ProdutoRepository extends JpaRepository<ProdutoModel,Long>{
	...
	public List<ProdutoModel>findAllByMarcaContainingIgnoreCase(String marcaProduto);
	public List<ProdutoModel>findAllByCategoriaContainingIgnoreCase(String categoriaProduto);
}
